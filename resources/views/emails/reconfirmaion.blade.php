        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                ...
                <div class="pt-lg-10 mb-10">
                    ...
                    @elseif($status == 3)
                    <div class="fs-3 fw-bold text-muted mb-10">Mail has been sent to your email <a href="mailto:{{$email}}" class="link-primary fw-bolder">{{$email}}</a></div>
                    @elseif($status == 1)
                    <div class="fs-3 fw-bold text-muted mb-10">Your email <a href="mailto:{{$email}}" class="link-primary fw-bolder">{{$email}}</a> subscribed successfully</div>
                    @else
                    <div class="fs-3 fw-bold text-muted mb-10">You are already subscribed with your email <a href="mailto:{{$email}}" class="link-primary fw-bolder">{{$email}}</a></div>
                    @endif
                    <!--end::Message-->
                </div>
                <!--end::Wrapper-->
