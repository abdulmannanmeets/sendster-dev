        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                        class="form-control form-control-solid w-250px ps-14" placeholder="Search sequence" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <!--begin::Add user-->
                    <button type="button" @click="$router.push({name: 'edit_sequences'})" class="btn btn-primary" data-kt-create-model="true">
                ...
                var e, t, n, r, mom, tb, o = document.getElementById("kt_table_users"), form_appear = document.querySelector('[data-kt-create-model="true"]'),
                    ...
                    l = () => {
                        ...
                        c.forEach((e => {
                            ...
                            Swal.fire({
                                text: "Are you sure you want to delete selected sequences?",
                                icon: "warning",
                                showCancelButton: !0,
                                buttonsStyling: !1,
                                confirmButtonText: "Yes, delete!",
                                ...
                                if (t.value) {
                                    ...
                                    axios.post("sequence", {
                                        ...
                                        Swal.fire({
                                            text: "You have deleted all selected sequences!.",
                                            icon: "success",
                                            buttonsStyling: !1,
                                            confirmButtonText: "Ok, got it!",
                                            customClass: {
                    ...
                    handleEditRows = () => {
                        const all_rows = document.querySelectorAll('[data-list-table-filter="delete_row"]');
                        all_rows.forEach(d => {
                            d.addEventListener("click", function (e) {
                                e.preventDefault();
                                ...
                                __this.$router.push({name: 'edit_sequences', query: {id: list_id}});
                            })
                        })
                    };
                const a = () => {
                ...
                return {
                    init: function () {
                        o && ((__this.dt = tb = e = $(o).DataTable({
                            ...
                            lengthChange: !0,
                            oLanguage: {
                                sEmptyTable: "No sequences found!"
                            },
                            columns: [
                                { data: 'id' },
                                { data: 'title' },
                            ...
                            columnDefs: [
                                ...
                                },
                                {
                                    ...
                                    render: function (data) {
                                        return `
                                            <button type="button" class="btn btn-primary btn-active-light-primary btn-sm me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-list-table-filter="delete_row" ><i class="bi bi-pencil"></i></button>
